...
# read in the genome_coverage file
genome_coverage <- read.delim("~/qbb2024-answers/week1/genome_coverage.txt")
...
# calculate the poisson distribution of coverage values ranging from 0 to the maximum coverage value. Change lambda to 3 to account for the 3x coverage
poisson_estimates <- genome_size * dpois(0:max_coverage, 3)

# calculate the normal distribution of coverage values ranging from 0 to the maximum coverage value. Change the mean to 3 and the standard deviation to 1.73 (the sqrt of 3)
normal_estimates <- genome_size * dnorm(0:max_coverage, 3, 1.73)
