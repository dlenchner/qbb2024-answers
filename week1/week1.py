...
coverage = 30               # 30x coverage of the genome    -   CHANGED TO 30X FOREXERCISE 1.6
...
# Answer: 300,000 reads are needed to achieve 30x coverage of a 1 Mbp genome with 100 bp reads
...
# for each of the 300,000 iterations (reads) calculated above
