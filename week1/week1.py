...
coverage = 10               # 10x coverage of the genome    -   CHANGED TO 10X FOREXERCISE 1.5
...
# Answer: 100,000 reads are needed to achieve 10x coverage of a 1 Mbp genome with 100 bp reads
...
# for each of the 100,000 iterations (reads) calculated above
